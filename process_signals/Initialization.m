...
registroLFP.multitaper_param.spectrogram.params.tapers = ([4 7]); % [TW K], (K <= to 2TW-1)
...
registroLFP.multitaper_param.spectrogram.movingwin.window = 1; % Ventanas (En segundos)
