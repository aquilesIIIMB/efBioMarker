...
%{
%% Tratamiento
db(1).param_ext.rec = {'/home/controlmotor/Aquiles/Fractales Biomarcador/Database/3. Lesion Intermedia/Maravilla (Suj01)/maravilla_2017-06-17_16-39-32/maravilla_2017-06-17_16-39-32.mat'};
db(1).param_ext.seg = {[7,12]};
db(1).param_ext.dbType = {'trat'}; % bm o trat
db(1).param_ext.hem = {'R'}; % L, R o LR
db(1).param_ext.area = {{'M1','DLS','VPL'}};
db(1).param_ext.class = {'L30'};

db(2).param_ext.rec = {'/home/controlmotor/Aquiles/Fractales Biomarcador/Database/3. Lesion Intermedia/Arturo (Suj02)/arturo_2017-06-09_15-24-39/arturo_2017-06-09_15-24-39.mat'};
db(2).param_ext.seg = {[7,12]};
db(2).param_ext.dbType = {'trat'}; % bm o trat
db(2).param_ext.hem = {'R'}; % L, R o LR
...
for idx_rec = 1:length(db)
    ...
    disp(db(idx_rec).param_ext.class{:})
